...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      title: 'Flutter Contact Selection',
      theme: new ThemeData(
...
class MyHomePage extends StatefulWidget {
  ...
  final String title;
  final String reloadLabel = 'Go Back';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    SimplePermissions.requestPermission(Permission.ReadContacts).then((granted) {
  ...
  //Future<bool> getContactsPermission() => SimplePermissions.requestPermission(Permission.ReadContacts);
}
